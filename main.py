...
first = (input('Now you\'re at a crossroad. Where do you want to go? Type "left" or "right:"\n'))
...
if first == "left":
  ...
  if second == "wait":
    final = (input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n")).lower()
    if final == "yellow":
